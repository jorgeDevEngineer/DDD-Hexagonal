...
export class UpdateQuizUseCase {
  ...
  async execute(quizIdStr: string, request: CreateQuizDto, authorId: string): Promise<Quiz> {
    ...
    // (Opcional) Validar que el autor sea el dueño
    // if (quiz.authorId.value !== authorId) throw new Error("Unauthorized");
